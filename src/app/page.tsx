  ...
  return (
    <div className='flex overflow-hidden'>
      ...
      <div className='lg:w-3/5 2xl:w-1/2 w-full h-[100vh] font-bold px-14 sm:px-16 md:px-24 xl:px-32 py-24 xxs:py-[10vh] xs:py-[12vh] sm:py-16 md:py-24 lg:py-8 xl:py-16 '>
        ...
        <Link href='/sign-in'>
          <button className="text-gray-200 before:ease block m-auto bg-[#fe3165] hover:bg-[#fe235a] transition duration-500 border-[#b4b4b4] rounded-lg border-2 text-xl max-w-md md:max-w-xl p-4 w-full">
